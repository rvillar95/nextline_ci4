-- Agregar módulo de categorías de galería
INSERT INTO `modulo` (`nombre`, `descripcion`, `ruta`, `estado`, `mostrar`, `sa`) VALUES
('Categorías de Galería', 'Gestión de categorías para proyectos de galería', 'dashboard/galeria-categoria', 'A', 'S', 'N');
...
(@modulo_id, 'Acción Obtener categorías para datatable', '/getGaleriaCategoria', 'ver', 'A', 'N', 0),
