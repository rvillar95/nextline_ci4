...
-- Obtener el ID del perfil "Administrador Web"
SET @admin_perfil_id = 8;

-- Agregar permisos para el perfil administrador
INSERT INTO `perfil_modulo` (`perfil_id`, `modulo_id`, `registrar`, `listar`, `editar`, `eliminar`) VALUES
(@admin_perfil_id, @testimonio_modulo_id, 1, 1, 1, 1);
