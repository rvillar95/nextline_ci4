...
class HistorialClinico extends Model
{
    ...
    protected $allowedFields = [
        ...
        'circunferencia_muslo_medio', 'circunferencia_muslo_maximo', 'circunferencia_pantorrilla', 'circunferencia_cuello', 'circunferencia_torax',
        'diametro_biacromial', 'diametro_bi_iliocristal', 'diametro_humero', 'diametro_femur', 'diametro_muneca', 'circunferencia_muneca', 'diametro_tobillo',
