...
class ModuloController extends BaseController
{
    ...
    public function eliminar()
    {
        ...
        $moduloDetalleModel = new ModuloDetalle();
        $perfilModuloModel = new \App\Models\PerfilModulo();
        
        $id = $this->request->getPost('id');
        
        // Eliminar primero los registros relacionados
        $moduloDetalleModel->where('modulo_id', $id)->delete();
        $perfilModuloModel->where('modulo_id', $id)->delete();
