                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 style="color: white; margin: 0;">
                            <i class="fas fa-edit me-2"></i> Editar Detalle de Módulo
                        </h2>
                        <p style="color: white; margin: 10px 0 0 0; opacity: 0.9;">
                            Modifique la información del detalle de módulo
                        </p>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" id="mostrar" name="mostrar" required>
                                    <option value="S" <?= ($perfil['mostrar'] ?? 'S') == 'S' ? 'selected' : '' ?>>Sí</option>
