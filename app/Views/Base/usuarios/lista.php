        ...
        <div class="col-12">
            ...
            <div class="main-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?= base_url('dashboard/usuario/registro') ?>" class="btn btn-light">
            ...
            <div class="card card-modern">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-modern getDetalleInventario" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Nombre</th>
                                    <th>Apellido</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="<?= base_url('dashboard/usuario/eliminar'); ?>" style="display: inline;">
                    <?= csrf_field() ?>
