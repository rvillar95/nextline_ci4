                            ...
                            <form id="formTema">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-2 flex-wrap">
                                        <input type="color" class="form-control form-control-color" id="color_primario" name="color_primario" value="<?= esc($usuario['color_primario'] ?? '#6aff99') ?>" title="Elegir color" style="width: 2.5rem; height: 2.5rem; padding: 2px; cursor: pointer;">
                                        
                                        <input type="text" class="form-control form-control-sm" id="color_primario_hex" maxlength="7" style="max-width: 100px;" value="<?= esc($usuario['color_primario'] ?? '#6aff99') ?>" placeholder="#6aff99">
                                    </div>
...
$(function() {
    ...
    function actualizarSwatch(hex) {
        $('#color_swatch').css('background-color', hex || '#6aff99');
    }
    ...
    $('#formTema').on('submit', function(e) {
        ...
        var color = $('#color_primario').val() || $('#color_primario_hex').val() || '#6aff99';
