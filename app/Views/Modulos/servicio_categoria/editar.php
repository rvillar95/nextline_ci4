        ...
        <div class="widget-header">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                    <h4>Editar Categoría de Servicio</h4>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" name="nombre" value="<?= $categoria->nombre; ?>" class="form-control" required placeholder="Ej: Construcción Residencial, Remodelaciones...">
