...
<?= $this->section('servicio_categoria/editar') ?>
...
<div class="container-fluid">
    <div class="main-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h2 style="color: white;"><i class="fas fa-edit me-2"></i> Editar Categoría de Servicio</h2>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" action="<?= base_url('dashboard/servicio-categoria/update') ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="icono" id="icono" class="form-control" 
                                       value="<?= old('icono', $categoria->icono) ?>" placeholder="Ej: fas fa-home, fas fa-tools">
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <input type="color" name="color" class="form-control form-control-color" 
                                           value="<?= old('color', $categoria->color ?: '#00bcd4') ?>" style="width: 80px; height: 40px; border: 2px solid #ddd; border-radius: 5px;">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea name="descripcion" class="form-control" rows="4" 
                                          placeholder="Descripción breve de qué tipo de servicios incluye esta categoría..."><?= old('descripcion', $categoria->descripcion) ?></textarea>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
