                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="descripcionCorta" class="form-control" 
                                           value="<?= old('descripcionCorta') ?>" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcionLarga" class="form-control" rows="5" required><?= old('descripcionLarga') ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="caracteristicas" class="form-control" rows="3" 
                                              placeholder="Una característica por línea"><?= old('caracteristicas') ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="beneficios" class="form-control" rows="3" 
                                              placeholder="Un beneficio por línea"><?= old('beneficios') ?></textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tiempo_estimado" class="form-control" 
                                           value="<?= old('tiempo_estimado') ?>" placeholder="Ej: 30 días, 2-3 meses">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="garantia" class="form-control" 
                                           value="<?= old('garantia') ?>" placeholder="Ej: 1 año, 6 meses">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="mostrar_precio" class="form-control">
                                        <option value="S" <?= old('mostrar_precio', 'S') == 'S' ? 'selected' : '' ?>>Sí</option>
                                        <option value="N" <?= old('mostrar_precio') == 'N' ? 'selected' : '' ?>>No</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="precio_desde" class="form-control" 
                                           value="<?= old('precio_desde') ?>" step="0.01" placeholder="0.00">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="precio_hasta" class="form-control" 
                                           value="<?= old('precio_hasta') ?>" step="0.01" placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="destacado" class="form-control">
                                        ...
                                        <option value="S" <?= old('destacado') == 'S' ? 'selected' : '' ?>>Sí</option>
                                    </select>
