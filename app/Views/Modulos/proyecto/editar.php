                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="area_construida" class="form-control" 
                                           value="<?= old('area_construida', $proyecto->area_construida) ?>" step="0.01" placeholder="0.00">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="estado_publico" class="form-control">
                                        <option value="A" <?= old('estado_publico', $proyecto->estado_publico ?? 'A') == 'A' ? 'selected' : '' ?>>Activo (Visible públicamente)</option>
                                        <option value="I" <?= old('estado_publico', $proyecto->estado_publico ?? 'A') == 'I' ? 'selected' : '' ?>>Inactivo (No visible públicamente)</option>
                                    </select>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion_corta" class="form-control" rows="2" 
                                              placeholder="Descripción breve del proyecto (máximo 500 caracteres)..."><?= old('descripcion_corta', $proyecto->descripcion_corta) ?></textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="caracteristicas_tecnicas" class="form-control" rows="3" 
                                              placeholder="Especificaciones técnicas, materiales especiales, sistemas utilizados..."><?= old('caracteristicas_tecnicas', $proyecto->caracteristicas_tecnicas) ?></textarea>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="materiales_principales" class="form-control" rows="2" 
                                              placeholder="Lista de materiales principales utilizados en el proyecto..."><?= old('materiales_principales', $proyecto->materiales_principales) ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="testimonio_cliente" class="form-control" rows="3" 
                                              placeholder="Testimonio o comentario del cliente sobre el proyecto..."><?= old('testimonio_cliente', $proyecto->testimonio_cliente) ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_cliente" class="form-control" 
                                           value="<?= old('nombre_cliente', $proyecto->nombre_cliente) ?>" placeholder="Nombre del cliente">
