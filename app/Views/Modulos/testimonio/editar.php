        ...
        <div class="col-12">
            ...
            <div class="main-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 style="color: white;"><i class="fas fa-edit me-2"></i> Editar Testimonio</h2>
                        <p style="color: white;">Modifique la información del testimonio y guarde los cambios</p>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="empresa" class="form-control" 
                                       value="<?= old('empresa', $testimonio->empresa) ?>" 
                                ...
                                <select name="proyecto_id" id="proyecto_id" class="form-control">
                                    ...
                                    <?php if (!empty($proyectos)): foreach ($proyectos as $proyecto): ?>
                                        <option value="<?= $proyecto->id ?>" 
                                                ...
                                                <?= old('proyecto_id', $testimonio->proyecto_id) == $proyecto->id ? 'selected' : '' ?>>
                                            <?= esc($proyecto->nombre) ?>
                                        </option>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <textarea name="testimonio" class="form-control" rows="6" required><?= old('testimonio', $testimonio->testimonio) ?></textarea>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="estado" class="form-control" required>
                                    <option value="A" <?= old('estado', $testimonio->estado) == 'A' ? 'selected' : '' ?>>✅ Activo (Visible en el sitio web)</option>
                                    <option value="I" <?= old('estado', $testimonio->estado) == 'I' ? 'selected' : '' ?>>❌ Inactivo (Oculto)</option>
                                </select>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="destacado" class="form-control" required>
                                    <option value="N" <?= old('destacado', $testimonio->destacado) == 'N' ? 'selected' : '' ?>>No</option>
                                    <option value="S" <?= old('destacado', $testimonio->destacado) == 'S' ? 'selected' : '' ?>>⭐ Sí, destacar en portada</option>
                                </select>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
