    ...
    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="widget-content widget-content-area br-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">Registro de Testimonio</h4>
            ...
            <form method="POST" action="<?= base_url('dashboard/testimonio/registrar') ?>">
                <?= csrf_field() ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="fecha_proyecto" class="form-control" value="<?= old('fecha_proyecto') ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
