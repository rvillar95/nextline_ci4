                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="tipo_paciente" class="form-control" required>
                                    ...
                                    <option value="fonasa" <?= old('tipo_paciente', $paciente->tipo_paciente ?? '') == 'fonasa' ? 'selected' : '' ?>>Fonasa</option>
                                    <option value="isapre" <?= old('tipo_paciente', $paciente->tipo_paciente ?? '') == 'isapre' ? 'selected' : '' ?>>Isapre</option>
                                    <option value="otro" <?= old('tipo_paciente', $paciente->tipo_paciente ?? '') == 'otro' ? 'selected' : '' ?>>Otro</option>
                                </select>
                            </div>
                        </div>
                    </div>
