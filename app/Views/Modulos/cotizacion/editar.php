                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="condiciones_pago" class="form-control" rows="3"><?= esc(old('condiciones_pago', $cotizacion->condiciones_generales ?? '')) ?></textarea>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="observaciones" class="form-control" rows="3"><?= esc(old('observaciones', $cotizacion->observaciones_especiales ?? '')) ?></textarea>
                                <small class="help-text">
                                    <i class="fas fa-lightbulb me-1"></i>
