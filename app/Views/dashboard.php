    ...
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="<?= base_url("lib/src/assets/img/logo2.svg") ?>" class="" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="index.html" class="nav-link"> CORKA </a>
            </li>
        </ul>
        ...
        <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="<?= base_url("lib/src/assets/img/1x1/us.svg") ?>" class="flag-width" alt="flag">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?= base_url("lib/src/assets/img/1x1/us.svg") ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?= base_url("lib/src/assets/img/1x1/tr.svg") ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Turkish</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?= base_url("lib/src/assets/img/1x1/br.svg") ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Portuguese</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?= base_url("lib/src/assets/img/1x1/in.svg") ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Hindi</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="<?= base_url("lib/src/assets/img/1x1/de.svg") ?>" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                </div>
            </li>
                    ...
                    <div class="notification-scroll">
                        <div class="dropdown-item">
                            <div class="media server-log">
                                <img src="<?= base_url("lib/src/assets/img/profile-16.jpeg") ?>" class="img-fluid me-2" alt="avatar">
                        ...
                        <div class="dropdown-item">
                            <div class="media ">
                                <img src="<?= base_url("lib/src/assets/img/profile-15.jpeg") ?>" class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">
                        ...
                        <div class="dropdown-item">
                            <div class="media file-upload">
                                <img src="<?= base_url("lib/src/assets/img/profile-21.jpeg") ?>" class="img-fluid me-2" alt="avatar">
                                <div class="media-body">
                                    <div class="data-info">
                            ...
                            <div class="widget-content">
                                <div class="account-box">
                                    ...
                                    <div class="info-box">
                                        <div class="icon">
                                            <span>
                                                <img src="<?= base_url("lib/src/assets/img/money-bag.png") ?>" alt="money-bag">
                                            </span>
                                        </div>
                                ...
                                <div class="meta-info">
                                    ...
                                    <div class="avatar--group">
                                        ...
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="<?= base_url("lib/src/assets/img/profile-8.jpeg") ?>" />
                                        </div>
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="<?= base_url("lib/src/assets/img/profile-12.jpeg") ?>" />
                                        </div>
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="<?= base_url("lib/src/assets/img/profile-19.jpeg") ?>" />
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="<?= base_url("lib/src/assets/img/g-8.png") ?>" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="card-bottom-section">
                                    ...
                                    <div class="img-group">
                                        <img src="<?= base_url("lib/src/assets/img/profile-19.jpeg") ?>" alt="avatar">
                                        <img src="<?= base_url("lib/src/assets/img/profile-6.jpeg") ?>" alt="avatar">
                                        <img src="<?= base_url("lib/src/assets/img/profile-8.jpeg") ?>" alt="avatar">
                                        <img src="<?= base_url("lib/src/assets/img/profile-3.jpeg") ?>" alt="avatar">
                                    </div>
