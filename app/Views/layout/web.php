...
<head>
    <meta charset="utf-8" />
    <title><?= $title ?? 'NutriNext - Gestión nutricional' ?></title>
    <link rel="icon" href="<?= base_url('lib/logo/icono-transparente.png') ?>" type="image/png" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="<?= $description ?? 'NutriNext - Plataforma de gestión para nutricionistas: agenda, pacientes, historiales y más' ?>" name="description" />
    <meta content="<?= $keywords ?? 'nutrinext, nutrición, nutricionista, agenda, consultas, pacientes, chile' ?>" name="keywords" />
    <meta content="NutriNext" name="author" />
    
        <!-- Open Graph / Facebook / WhatsApp -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?= current_url() ?>" />
    <meta property="og:title" content="<?= $title ?? 'NutriNext - Gestión nutricional' ?>" />
    ...
    <meta property="og:site_name" content="NutriNext" />
    <meta property="og:locale" content="es_CL" />
    
    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:url" content="<?= current_url() ?>" />
    <meta name="twitter:title" content="<?= $title ?? 'NutriNext - Gestión nutricional' ?>" />
    ...
    <style>
        ...
        #section-highlight { background: linear-gradient(135deg, var(--nutrinext-primary), var(--nutrinext-muted)) !important; }
        ...
        .footer-modern {
            background: linear-gradient(to bottom, var(--nutrinext-primary) 0%, #3ab892 100%);
            color: white;
            padding: 80px 0 0;
            position: relative;
            overflow: hidden;
                ...
                <div class="header-content-modern">
                    ...
                    <div class="logo-modern">
                        <a href="<?= base_url() ?>" class="logo-link-modern">
                            <img src="<?= base_url('lib/logo/logo-grande-sin-margen.png') ?>" alt="NutriNext" class="logo-img-modern" style="max-height: 75px; width: auto;" loading="eager">
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="footer-widget-modern">
                            <div class="footer-logo-modern">
                                <a href="<?= base_url() ?>">
                                    <img alt="NutriNext" src="<?= base_url('lib/logo/logo-grande-sin-margen.png') ?>" style="max-height: 44px; width: auto;" loading="lazy" />
                                </a>
