...
<section class="py-5" style="background: var(--nutrisync-bg, #fafeff);">
    <div class="container">
...
<style>
.reservar-hero {
    background: linear-gradient(135deg, var(--nutrisync-primary) 0%, var(--nutrisync-muted) 100%);
    padding: 80px 0 60px !important;
}
.nutricionista-card { transition: all 0.2s ease; }
.nutricionista-card:hover { border-color: var(--nutrisync-primary) !important; box-shadow: 0 4px 12px rgba(77, 203, 165, 0.2); }
.nutricionista-card.selected { border-color: var(--nutrisync-primary) !important; background: rgba(77, 203, 165, 0.08); box-shadow: 0 0 0 2px var(--nutrisync-primary); }
...
a.btn-buscar-horarios {
    ...
    color: #fff;
    border: 1px solid var(--nutrisync-primary);
