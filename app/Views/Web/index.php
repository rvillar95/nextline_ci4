...
<html lang="zxx">
  <head>
    ...
    <link rel="icon" href="lib/images/logo_transparente_grande.ico" type="image/x-icon" />
    ...
    <link href="lib/css/owl.theme.css" rel="stylesheet" type="text/css" />
    <link href="lib/css/owl.transitions.css" rel="stylesheet" type="text/css" />
    <link href="lib/css/magnific-popup.css" rel="stylesheet" type="text/css" />
    <link href="lib/css/jquery.countdown.css" rel="stylesheet" type="text/css" />
    <link href="lib/css/style.css" rel="stylesheet" type="text/css" />
    <!-- color scheme -->
    <link
      id="colors"
      href="lib/css/colors/scheme-01.css"
      rel="stylesheet"
      type="text/css"
    />
    <link href="lib/css/coloring.css" rel="stylesheet" type="text/css" />
    <!-- RS5.0 Stylesheet -->
    <link rel="stylesheet" href="lib/css/settings.css" type="text/css" />
    <link rel="stylesheet" href="lib/css/layers.css" type="text/css" />
    <link rel="stylesheet" href="lib/css/navigation.css" type="text/css" />
  </head>
  ...
  <body>
        ...
        <div class="container">
          <div class="topbar-left sm-hide">
            <span class="topbar-widget tb-social">
              <a href="lib/#"><i class="fa fa-facebook"></i></a>
              <a href="lib/#"><i class="fa fa-twitter"></i></a>
              <a href="lib/#"><i class="fa fa-instagram"></i></a>
            </span>
          </div>
          <div class="topbar-right">
            <div class="topbar-right">
              <span class="topbar-widget"><a href="lib/#">Privacy policy</a></span>
              <span class="topbar-widget"><a href="lib/#">Request Quote</a></span>
              <span class="topbar-widget"><a href="lib/#">FAQ</a></span>
            </div>
          </div>
            ...
            <div class="col-md-12">
              <div class="de-flex sm-pt10">
                <div class="de-flex-col">
                  ...
                  <div id="logo">
                    <a href="lib/index.html">
                      <img alt="" class="logo" src="lib/images/logo-light.png" />
                      <img alt="" class="logo-2" src="lib/images/logo.png" />
                    </a>
                  </div>
                  <!-- logo close -->
                </div>
                <div class="de-flex-col header-col-mid">
                  ...
                  <ul id="mainmenu">
                    <li>
                      <a href="lib/index.html">Home</a>
                      <ul>
                        <li>
                          <a href="lib/index-9.html"><b>New</b> Homepage 9</a>
                        </li>
                        <li>
                          <a href="lib/index-8.html"><b>New</b> Homepage 8</a>
                        </li>
                        <li><a href="lib/index.html">Homepage 1</a></li>
                        <li><a href="lib/index-2.html">Homepage 2</a></li>
                        <li><a href="lib/index-3.html">Homepage 3</a></li>
                        <li><a href="lib/index-4.html">Homepage 4</a></li>
                        <li><a href="lib/index-5.html">Homepage 5</a></li>
                        <li><a href="lib/index-6.html">Homepage 6</a></li>
                        <li><a href="lib/index-7.html">Homepage 7</a></li>
                        <li><a href="lib/index-onepage.html">Onepage</a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="lib/about.html">About</a>
                      <ul>
                        <li><a href="lib/about.html">About Us</a></li>
                        <li><a href="lib/team.html">The Team</a></li>
                        <li><a href="lib/faq.html">FAQ</a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="lib/practice-areas.html">Practice Areas</a>
                      <ul>
                        <li>
                          <a href="lib/practice-areas-4.html"
                            ><b>New</b>Practice Areas 4</a
                          >
                        </li>
                        <li>
                          <a href="lib/practice-areas.html">Practice Areas 1</a>
                        </li>
                        <li>
                          <a href="lib/practice-areas-2.html">Practice Areas 2</a>
                        </li>
                        <li>
                          <a href="lib/practice-areas-3.html">Practice Areas 3</a>
                        </li>
                      </ul>
                    </li>
                    <li>
                      <a href="lib/news.html">News</a>
                      <ul>
                        <li><a href="lib/news.html">News List</a></li>
                        <li><a href="lib/news-single.html">News Single</a></li>
                      </ul>
                    </li>
                    <li><a href="lib/contact.html">Contact</a></li>
                    <li>
                      <a href="lib/#">Elements</a>
                      <ul>
                        <li><a href="lib/accordion.html">Accordion</a></li>
                        <li><a href="lib/alerts.html">Alerts</a></li>
                        <li><a href="lib/counters.html">Counters</a></li>
                        <li><a href="lib/faq.html">FAQ</a></li>
                        <li><a href="lib/gallery.html">Gallery</a></li>
                        <li><a href="lib/icon-set-1.html">Icon Set 1</a></li>
                        <li><a href="lib/modal.html">Modal</a></li>
                        <li><a href="lib/progress-bar.html">Progress Bar</a></li>
                        <li><a href="lib/tabs.html">Tabs</a></li>
                        <li><a href="lib/testimonials.html">Testimonials</a></li>
                      </ul>
                    </li>
                  </ul>
                  <!-- mainmenu close -->
      ...
      <div class="no-bottom no-top" id="content">
        ...
        >
          ...
          <div class="carousel-inner">
            ...
            <div
              ...
              data-bgimage="url(lib/images/slider/1.jpg)"
            >
              <div class="mask">
                <div
                ...
                >
                  <div class="container text-white">
                    <div class="row">
                      <div class="col-lg-5">
                        <h4 class="id-color wow fadeInUp">Need Any Help?</h4>
                        <h1 class="mb-3 wow fadeInUp">We Fight for Right</h1>
                        <p class="lead wow fadeInUp" data-wow-delay=".3s">
                          Providing legal representation and counsel to
                          safeguard your rights. Navigate complex legal
                          challenges, and pursue justice with unwavering
                          dedication.
                        </p>
                        <div class="spacer-10"></div>
                        <a
                          href="lib/practice-areas-4.html"
                          class="btn-custom wow fadeInUp"
                          data-wow-delay=".6s"
                          >Explore</a
                        >
                      </div>
            ...
            <!-- Single item -->
            <div class="carousel-item" data-bgimage="url(lib/images/slider/2.jpg)">
              <div class="mask">
                <div
                  class="d-flex justify-content-center align-items-center h-100"
                >
                  <div class="container text-white">
                    <div class="row">
                      <div class="col-lg-5">
                        <h4 class="id-color wow fadeInUp">
                          Law &amp; Insurance Specialist
                        </h4>
                        <h1 class="mb-3 wow fadeInUp">Because We Care</h1>
                        <p class="lead wow fadeInUp" data-wow-delay=".3s">
                          Providing legal representation and counsel to
                          safeguard your rights. Navigate complex legal
                          challenges, and pursue justice with unwavering
          ...
          <div class="container">
            <div class="row align-items-center">
              ...
              <div class="col-md-4 text-lg-end rtl-lg-start text-sm-center">
                <a href="lib/#" class="btn-custom btn-black light"
                  >Make Appointment</a
                >
              </div>
            </div>
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-md-4">
                ...
                <h2>Reputation.<br />Respect. Result.</h2>
        ...
        <section class="no-top relative z1000">
          <div class="container">
            <div class="row mt-100">
              <div
                class="col-md-4 mb-sm-30 wow fadeInRight"
                data-wow-delay=".2s"
              >
                <div class="mask">
                  <div class="cover">
                    <div class="c-inner">
                      <h3>
                        <i class="icofont-people"></i><span>Business Law</span>
                      </h3>
                      <p>
                      ...
                      <a href="lib/#" class="btn-custom capsule">Read more</a>
                    </div>
                  </div>
                  <img
                    src="lib/images/services/1.jpg"
                    alt=""
              ...
              >
                <div class="mask">
                  <div class="cover">
                    <div class="c-inner">
                      <h3>
                        <i class="icofont-home"></i><span>Family Law</span>
                      </h3>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
        ...
        <section data-bgcolor="#111111" class="text-light">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-5 offset-lg-7">
                ...
                <h2>Let Our Experience<br />be Your Guide</h2>
          ...
          <div class="jarallax image-container col-md-6 pull-right">
            <img src="lib/images/background/9.jpg" class="jarallax-img" alt="" />
          </div>
        </section>
        ...
        <section class="jarallax text-light">
          <img src="lib/images/background/2.jpg" class="jarallax-img" alt="" />
          <div class="container">
            <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-8 offset-md-1">
                <div class="row">
                  ...
                  >
                    <div class="de_count">
                      <h3>
                        <span class="timer" data-to="16" data-speed="3000"
                          >0</span
                        >k
                      </h3>
                  ...
                  >
                    <div class="de_count">
                      <h3>
                        <span class="timer" data-to="4" data-speed="3000"
                          >0</span
                        >m
                      </h3>
                  ...
                  >
                    <div class="de_count">
                      <h3>
                        <span class="timer" data-to="52" data-speed="3000"
                          >0</span
                        >k
                      </h3>
                  ...
                  >
                    <div class="de_count">
                      <h3>
                        <span class="timer" data-to="100" data-speed="3000"
                          >0</span
                        >+
                      </h3>
                  ...
                  >
                    <div class="de_count">
                      <h3>
                        <span class="timer" data-to="2" data-speed="3000"
                          >2</span
                        >k
                      </h3>
                    ...
                    <div class="fpw-overlay">
                      <div class="fpwo-wrap">
                        <div class="fpwow-icons">
                          <a href="lib/#"><i class="fa fa-facebook fa-lg"></i></a>
                          <a href="lib/#"><i class="fa fa-twitter fa-lg"></i></a>
                          <a href="lib/#"><i class="fa fa-linkedin fa-lg"></i></a>
                          <a href="lib/#"><i class="fa fa-pinterest fa-lg"></i></a>
                        </div>
                      </div>
                    </div>
                    <div class="fpw-overlay-btm"></div>
                    <img
                      src="lib/images/team/1.jpg"
        ...
        <section aria-label="section" class="jarallax text-light">
          <img src="lib/images/background/3.jpg" class="jarallax-img" alt="" />
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="bloglist item">
                  <div class="post-content">
                    ...
                    <div class="post-image">
                      <img alt="" src="lib/images/news/1.jpg" />
                    </div>
                    <div class="post-text">
                      <span class="p-tagline">Law Firm</span>
                      <h4>
                        <a href="lib/news-single.html"
                          >The Lawyer European Awards shortlist<span></span
                        ></a>
                      </h4>
                      <p>
              ...
              <div class="col-lg-4 col-md-6 mb30">
                <div class="bloglist item">
                  <div class="post-content">
                    ...
                    <div class="post-image">
                      <img alt="" src="lib/images/news/2.jpg" />
                    </div>
                    <div class="post-text">
                      <span class="p-tagline">Law Firm</span>
                      <h4>
                        <a href="lib/news-single.html"
                          >Six firms that are setting the trend<span></span
                        ></a>
                      </h4>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
              ...
              <div class="col-lg-4 col-md-6 mb30">
                <div class="bloglist item">
                  <div class="post-content">
                    ...
                    <div class="post-image">
                      <img alt="" src="lib/images/news/3.jpg" />
                    </div>
                    <div class="post-text">
                      <span class="p-tagline">Law Firm</span>
                      <h4>
                        <a href="lib/news-single.html"
                          >When it comes to law firm mergers<span></span
                        ></a>
                      </h4>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing
              ...
              <div class="widget">
                ...
                <address class="s1">
                  ...
                  <span
                    ...
                    ><a href="lib/mailto:contact@example.com"
                      >contact@example.com</a
                    ></span
                  >
                  <span
                    ><i class="id-color fa fa-file-pdf-o fa-lg"></i
                    ><a href="lib/#">Download Brochure</a></span
                  >
                </address>
              </div>
            </div>
            <div class="col-md-4">
              <h4 class="id-color mb20">Practice Areas</h4>
              <ul class="ul-style-2">
                <li>Corporate and M&A</li>
                <li>Construction and Real Estate</li>
                <li>Commercial Duspute Resolution</li>
            ...
            <div class="row g-4 align-items-center">
              ...
              <div class="col-lg-6 text-lg-end">
                <div class="social-icons">
                  ...
                  <a href="lib/#"><i class="fa fa-linkedin fa-lg"></i></a>
                  <a href="lib/#"><i class="fa fa-pinterest fa-lg"></i></a>
                  <a href="lib/#"><i class="fa fa-rss fa-lg"></i></a>
                </div>
              </div>
            </div>
          </div>
    ...
    <script src="lib/js/enquire.min.js"></script>
    <script src="lib/js/jquery.stellar.min.js"></script>
    <script src="lib/js/jquery.plugin.js"></script>
    <script src="lib/js/typed.js"></script>
    <script src="lib/js/jarallax.js"></script>
    <script src="lib/js/jquery.countTo.js"></script>
    <script src="lib/js/jquery.countdown.js"></script>
    <script src="lib/js/typed.js"></script>
    <script src="lib/js/jarallax.js"></script>
    <script src="lib/js/mdb.min.js"></script>
    <script src="lib/js/designesia.js"></script>
  </body>
</html>
