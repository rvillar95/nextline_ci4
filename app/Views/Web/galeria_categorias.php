        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="spacer-single"></div>
                    <h1 class="text-center text-white">Categorías de Galería</h1>
                    <p class="text-center text-white lead">Explora nuestras obras organizadas por tipo de proyecto</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <?php if (empty($categorias)): ?>
                <div class="col-lg-12 text-center">
                    ...
                    <p>Próximamente agregaremos más categorías de galería.</p>
                </div>
            <?php else: ?>
                            ...
                            <div class="category-content">
                                ...
                                <div class="category-stats">
                                    <span class="gallery-count">
                                        ...
                                        <?= count($galerias_por_categoria[$categoria->id] ?? []) ?> obras
                                    </span>
                                </div>
                                <div class="spacer-10"></div>
                                <a href="<?= base_url('galeria-categorias/' . $categoria->slug) ?>" class="btn-custom btn-sm">Ver Obras</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
