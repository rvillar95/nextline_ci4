    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: true,
                logo: {
                    darkLogo: '../lib/logo/logo-horizontal.png',
                    lightLogo: '../lib/logo/logo-horizontal.png'
                }
            }
        },
        reset: false
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../lib/logo/logo-horizontal.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
