window.addEventListener("load", function(){
  try {
    // No ejecutar en páginas que no son el dashboard (ej. historial/editar, agenda/consulta)
    // para evitar "Element not found" de ApexCharts y PerfectScrollbar y que se rompan otros scripts
    if (!document.querySelector('#total-users')) return;
